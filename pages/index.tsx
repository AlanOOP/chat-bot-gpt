...
export default function Home() {
  ...
  const [messageState, setMessageState] = useState<{
    ...
    messages: [
      {
        // message es español : Hola, ¿qué te gustaría aprender sobre este documento?
        message: 'Hola, ¿qué te gustaría aprender sobre este documento?', 
        type: 'apiMessage',
      },
    ],
    history: [],
  ...
  async function handleSubmit(e: any) {
    ...
    try {
      ...
      setLoading(false);
      setError('Ha ocurrido un error. Porfavor intente de nuevo.');
